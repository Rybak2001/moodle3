...
/**
 * Strings for component 'grades', language 'es_mx', version '4.2'.
 *
 * @package     grades
 * @category    string
...
$string['noresultsfor'] = 'Sin resultados parar "{$a}"';
...
$string['usermatchedon'] = 'Este usuario concuerda con la búsqueda vía el campo siguiente';
